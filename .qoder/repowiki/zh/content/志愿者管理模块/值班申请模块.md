...
- [AdminDutyApplicationController.java:1-131](file://src/main/java/com/daily/dailychineseculture/controller/AdminDutyApplicationController.java#L1-L131)
...
- **DutyAssignmentMapper**：处理职位分配记录的数据库操作

### 实体组件
- **DutyApplication**：值班申请实体类
- **DutyAssignment**：职位分配实体类
...
AIS[AdminDutyApplicationService<br/>管理端服务]
end
subgraph "数据访问层"
...
participant AdminService as AdminDutyApplicationService
...
**章节来源**
- [AdminDutyApplicationController.java:46-129](file://src/main/java/com/daily/dailychineseculture/controller/AdminDutyApplicationController.java#L46-L129)
